...
for file in files:
	try:
		p = angr.Project('/home/kitty/onlab/ml-sample-pack-small/benign/arm/'+file, load_options={'auto_load_libs':False})
		cfg = p.analyses.CFGFast()
		G = cfg.graph
		os.mkdir(f'/home/kitty/onlab/outputs/benign_sol/{file}')

		with open(f'/home/kitty/onlab/outputs/benign_sol/{file}/running_error.txt', 'w') as fe:
			with open(f'/home/kitty/onlab/outputs/benign_sol/{file}/feature_vector.txt', 'w') as f:
				sys.stdout = fe
		...
		with open(f'/home/kitty/onlab/outputs/benign_sol/{file}/exception.txt', 'w') as fem:
			fem.write(str(e))
		continue
